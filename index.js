...
app.use(
    session({
        store: new MongoStore({
            mongoUrl: `mongodb+srv://${process.env.MONGO_DB_USER}:${process.env.MONGO_DB_PASSWORD}@cluster0.rfoqhb6.mongodb.net/${process.env.SESSION_DB}?retryWrites=true&w=majority`,
